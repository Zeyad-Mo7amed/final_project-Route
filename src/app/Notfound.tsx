      ...
      <div className="jsx-f1a4a174e49dbaab min-h-screen bg-[#fafbfc] flex items-center justify-center px-4 py-16 relative overflow-hidden">
        ...
        <div className="jsx-f1a4a174e49dbaab relative z-10 max-w-xl w-full">
          ...
          <div className="jsx-f1a4a174e49dbaab flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            ...
            <button
              className="jsx-f1a4a174e49dbaab group w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-700 py-4 px-8 rounded-2xl font-bold text-lg transition-all duration-300 shadow-md hover:shadow-lg border border-gray-200 hover:-translate-y-1"
            >
              <svg
                data-prefix="fas"
                data-icon="arrow-left"
                className="h-[1em] svg-inline--fa fa-arrow-left group-hover:-translate-x-1 transition-transform duration-300"
                role="img"
                viewBox="0 0 512 512"
                aria-hidden="true"
              >
