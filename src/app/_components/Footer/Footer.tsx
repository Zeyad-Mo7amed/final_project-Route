          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
            <div className="lg:col-span-4">
              ...
              <div className="space-y-3 mb-6">
                ...
                >
                  <svg
                    data-prefix="fas"
                    data-icon="phone"
                    className="h-[1em] text-green-700 svg-inline--fa fa-phone text-primary-500"
                    role="img"
                    viewBox="0 0 512 512"
                    aria-hidden="true"
                  >
                ...
                >
                  <svg
                    data-prefix="fas"
                    data-icon="envelope"
                    className="h-[1em] text-green-700 svg-inline--fa fa-envelope text-primary-500"
                    role="img"
                    viewBox="0 0 512 512"
                    aria-hidden="true"
                  >
                ...
                <div className="flex items-start gap-3 text-gray-400 text-sm">
                  <svg
                    ...
                    className="h-[1em] text-green-700 svg-inline--fa fa-location-dot text-primary-500 mt-0.5"
                    role="img"
                    viewBox="0 0 384 512"
                    aria-hidden="true"
                  >
              ...
              <div className="flex items-center gap-3">
                <Link
                  href="#"
                  className="w-10 hover:bg-[#16A34A] h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-primary-600 hover:text-white transition-colors"
                >
                  <svg
                    data-prefix="fab"
                    data-icon="facebook-f"
                    className="h-[1em] svg-inline--fa fa-facebook-f"
                    role="img"
                    viewBox="0 0 320 512"
                    aria-hidden="true"
                  >
                ...
                >
                  <svg
                    data-prefix="fab"
                    data-icon="twitter"
                    className=" h-[1em]  svg-inline--fa fa-twitter"
                    role="img"
                    viewBox="0 0 512 512"
                    aria-hidden="true"
                  >
                ...
                >
                  <svg
                    data-prefix="fab"
                    data-icon="instagram"
                    className="h-[1em] svg-inline--fa fa-instagram"
                    role="img"
                    viewBox="0 0 448 512"
                    aria-hidden="true"
                  >
                ...
                >
                  <svg
                    data-prefix="fab"
                    data-icon="youtube"
                    className="h-[1em] svg-inline--fa fa-youtube"
                    role="img"
                    viewBox="0 0 576 512"
                    aria-hidden="true"
                  >
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2 text-gray-500 text-sm">
                  <svg
                    ...
                    className="h-[1em] svg-inline--fa fa-credit-card"
                    role="img"
                    viewBox="0 0 512 512"
                    aria-hidden="true"
                  >
