...
import img1 from "../../../assets/final-project/home-slider-1.d79601a8.png";
import img2 from "../../../assets/final-project/home-slider-1.d79601a8.png";
import img3 from "../../../assets/final-project/home-slider-1.d79601a8.png";
  ...
  const slides = [
    {
      ...
      btn1: { text: "Shop Now", link: "/products" },
    ...
    },
    {
      ...
      btn1: { text: "Order Now", link: "/products" },
      btn2: { text: "Delivery Info", link: "/delivery" },
    },
  ];
  ...
  return (
    <>
      <div className="relative">
        <div
          className="h-[400px] flex items-center relative overflow-hidden transition-all duration-500"
          style={{
            backgroundImage: `url(${slides[current].image.src})`,
        ...
        >
          ...
          <div className="relative  z-10 container text-white overflow-hidden">
            <div key={current} className="animate-slide mx-9 px-10">
              ...
              <div className="flex gap-3">
                <Link
                  href={slides[current].btn1.link}
                  className="bg-white text-green-600 px-6 py-2 rounded-lg font-semibold"
                >
                  {slides[current].btn1.text}
                </Link>

                <Link
                  href={slides[current].btn2.link}
                  className="border border-white text-white px-6 py-2 rounded-lg font-semibold"
                >
                  {slides[current].btn2.text}
                </Link>
              </div>
            </div>
          </div>
          ...
          >
            <svg
              ...
              className="h-[1em] svg-inline--fa fa-chevron-left text-lg"
              role="img"
              viewBox="0 0 320 512"
              aria-hidden="true"
            >
          ...
          >
            <svg
              ...
              className="h-[1em] svg-inline--fa fa-chevron-right text-lg"
              role="img"
              viewBox="0 0 320 512"
              aria-hidden="true"
            >
          ...
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-3">
            {slides.map((_, index) => (
              <button title="dsa"
                ...
                ${
                  current === index
                    ? "w-5 h-5 border-2 border-white bg-transparent"
                    : "w-3 h-3 bg-white/60"
                }`}
              />
            ))}
            ...
            >
              <div className="bg-emerald-50 text-emerald-500 w-12 h-12 rounded-full flex items-center justify-center shrink-0">
                <svg
                  ...
                  className="h-[1em] svg-inline--fa fa-shield-halved text-xl"
                  role="img"
                  viewBox="0 0 512 512"
                  aria-hidden="true"
                >
            ...
            >
              <div className="bg-orange-50 text-orange-500 w-12 h-12 rounded-full flex items-center justify-center shrink-0">
                <svg
                  ...
                  className="h-[1em] svg-inline--fa fa-arrow-rotate-left text-xl"
                  role="img"
                  viewBox="0 0 512 512"
                  aria-hidden="true"
                >
            ...
            >
              <div className="bg-purple-50 text-purple-500 w-12 h-12 rounded-full flex items-center justify-center shrink-0">
                <svg
                  data-prefix="fas"
                  data-icon="headset"
                  className="h-[1em] svg-inline--fa fa-headset text-xl"
                  role="img"
                  viewBox="0 0 448 512"
                  aria-hidden="true"
                >
